...
int main()
{
    RotationQuaternion q1(1, 0, 0, 0);
    RotationQuaternion q2(-0.383, 0, 0,0.924);
    ...
    // Calculate the distance between q1 and q2
    double dist = RotationQuaternion::distance(q1, q2);
    std::cout << "Distance between q1 and q2: " << dist << " radians" << std::endl;
